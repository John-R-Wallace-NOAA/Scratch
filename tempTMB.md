...
Regardless, even with Rtools 3.5’s location for gdb.exe in the system path (C:/Rtools/mingw_64/bin); for the compile options given in the R help for gdbsource(), and for many other options I have tried, no line numbers are given in the gdb Windows error output. 
